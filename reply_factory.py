...
def record_current_answer(answer, current_question_id, session):
    ...
    # Assuming each question has a corresponding ID and the answer should be stored with the same ID
    question_key = f"answer_{current_question_id}"
...
def generate_final_response(session):
    ...
    for i in range(total_questions):
        ...
        user_answer = session.get(answer_key)
